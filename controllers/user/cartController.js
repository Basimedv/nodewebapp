...
// ── HELPER: Calculate final price after best active offer ────────
// (Same logic as used on the shop / product details pages)
...
const addToCart = async (req, res) => {
    try {
        ...
        // ✅ populate category — needed to check category-level offers
        ...
        // ✅ Calculate price using active product/category offers (same as shop page)
        const price = await getProductFinalPrice(product);
        ...
        if (existingIndex > -1) {
            ...
            cart.items[existingIndex].price      = price; // ✅ refresh price in case offer changed
