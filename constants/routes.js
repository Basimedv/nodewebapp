const ROUTES = {
    USER: {
        ...
        AVAILABLE_COUPONS:      "/checkout/available-coupons",
        ...
        ORDER_FAILURE:          "/order-failure/:id",  
        ORDERS:                 "/orders",
    ...
    ADMIN: {
        ...
        COUPONS_EDIT:           "/admin/coupons/:id/edit",
        COUPONS_TOGGLE:         "/admin/coupons/:id/toggle",
        COUPONS_DELETE:         "/admin/coupons/:id",

        SALES_REPORT:           "/admin/sales-report",
        SALES_REPORT_PDF:       "/admin/sales-report/export-pdf",
        SALES_REPORT_EXCEL:     "/admin/sales-report/export-excel",
    }
};
