...
router.post(ROUTES.USER.PROFILE_UPDATE, userAuth,
    uploadProfile.single('profileImage'), profileController.updateProfile);
...
router.get(ROUTES.USER.RESET_PASSWORD,
    profileController.ensureOtpVerified, profileController.getResetPassPage);
router.post(ROUTES.USER.RESET_PASSWORD,
    profileController.ensureOtpVerified, profileController.resetPassword);
...
router.get(ROUTES.USER.AVAILABLE_COUPONS, userAuth, checkoutController.getAvailableCoupons);
...
router.get(ROUTES.USER.ORDER_FAILURE, userAuth, checkoutController.getOrderFailure); // ✅ NEW
...
// ── Orders ────────────────────────────────────────────────────────
router.get(ROUTES.USER.ORDERS,       userAuth, orderController.getOrders);
router.get(ROUTES.USER.ORDER_DETAILS, userAuth, orderController.getOrderDetail);
router.post(ROUTES.USER.ORDER_CANCEL, userAuth, orderController.cancelOrder);
router.post(ROUTES.USER.ORDER_RETURN, userAuth, orderController.requestReturn);
